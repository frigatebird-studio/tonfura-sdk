...
export type JettonMastersParams = {
  address?: string;
  admin_address?: string;
  limit?: number;
  offset?: number;
};
export type JettonMastersResult =
  import('./output/ton_jetton_masters').ReturnJettonMaster[];

export type JettonWalletsParams = {
  address?: string;
...
export type JettonWalletsResult =
  import('./output/ton_jetton_wallets').ReturnJettonWallet[];

export type JettonTransfersParams = {
  address?: string;
...
export type JettonTransfersResult =
  import('./output/ton_jetton_transfers').ReturnJettonTransfer[];

export type JettonBurnsParams = {
  address?: string;
  jetton_wallet?: string;
  jetton_master?: string;
  direction?: string;
...
export type JettonBurnsResult =
  import('./output/ton_jetton_burns').ReturnJettonBurn[];

export type NFTItemsParams = {
  address?: string;
  owner_address?: string;
...
export type NFTItemsResult = import('./output/ton_nft_items').ReturnNFTItem[];
